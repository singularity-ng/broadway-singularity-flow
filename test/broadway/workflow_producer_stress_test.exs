defmodule Broadway.SingularityWorkflowsProducerStressTest do
  ...
  describe "performance benchmarks vs DummyProducer" do
    test "benchmarks throughput: 10000 messages", %{workflow_pid: workflow_pid} do
      ...
      # Benchmark SingularityWorkflowsProducer
      {singularity_workflows_time, _} = :timer.tc(fn ->
        ...
        expect(Broadway, :push_messages, 20, fn Broadway.SingularityWorkflowsProducer, messages ->
      ...
      # Log results
      IO.puts("SingularityWorkflowsProducer time: #{singularity_workflows_time / 1000}ms")
      IO.puts("DummyProducer time: #{dummy_time / 1000}ms")
      IO.puts("Throughput ratio: #{dummy_time / singularity_workflows_time}")

      # SingularityWorkflow should be reasonably close (within 2x) due to orchestration overhead
      assert singularity_workflows_time < dummy_time * 3
