defmodule Broadway.SingularityWorkflow do
  @version "0.1.0"

  @moduledoc """
  Broadway.SingularityWorkflow is a Broadway-compatible producer adapter backed by SingularityWorkflow workflows.
 
  Overview
 
  Provides durable, orchestrated message production using PostgreSQL-backed SingularityWorkflow workflows.
  ...
  Configure SingularityWorkflow and repo in your application config; see README for details.
