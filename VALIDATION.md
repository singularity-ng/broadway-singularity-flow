# Validation Report — Broadway.SingularityWorkflowsProducer

Repository: [`packages/broadway_singularity_flow`](packages/broadway_singularity_flow:1)
...
- Created a Benchee-based microbenchmark: [`bench/bench.exs`](packages/broadway_singularity_flow/bench/bench.exs:1)
  ...
  - Writes summary to [`bench/results.md`](packages/broadway_singularity_flow/bench/results.md:1).
...
- Attempted to run bench script via `elixir packages/broadway_singularity_flow/bench/bench.exs` — failed: `/bin/sh: elixir: command not found`.
...
2. Run `mix run ./packages/broadway_singularity_flow/bench/bench.exs` in staging with seeded queues (1_000 / 10_000) and collect `bench/results.md`.
