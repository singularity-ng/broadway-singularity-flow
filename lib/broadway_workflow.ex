defmodule Broadway.Workflow do
  @version "0.1.0"

  @moduledoc """
  Broadway.Workflow is a Broadway-compatible producer adapter backed by Singularity Workflow orchestration.

  Overview

  Provides durable, orchestrated message production using PostgreSQL-backed Singularity Workflow.
  ...
  ```elixir
  {:ok, _pid} = Broadway.WorkflowProducer.start_link(
    workflow_name: "my_pipeline",
    queue_name: "my_jobs",
    concurrency: 10,
    batch_size: 16,
    workflow_config: [timeout_ms: 300_000, retries: 3],
  ...
  Configure Singularity Workflow and repo in your application config; see README for details.
